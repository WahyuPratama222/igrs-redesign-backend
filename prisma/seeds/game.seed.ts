...
export async function seedGames(prisma: PrismaClient) {
  ...
  const gamesData = [
    ...
    },
    {
      ...
      cover_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/covers/wukong-cover.jpeg',
      background_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/backgrounds/wukong-background.webp',
      description: 'Black Myth: Wukong adalah RPG aksi yang berakar pada mitologi Tiongkok. Anda akan berangkat sebagai Takdir untuk bertualang ke dalam tantangan di depan.',
      trailer_url: 'https://youtu.be/u83VdXAVq08?si=3UcJPvJeAAdvbXRE',
      trailer_duration: '01:24',
      platform: ['PC', 'PlayStation'],
      release_year: 2024,
      developer: 'Game Science',
      size: '130 GB',
      game_modes: ['Singleplayer', 'Offline'],
      is_popular: false,
      rating_code: '13+',
      genres: [
        { name: 'Action', slug: 'action' },
      ...
      content_descriptors: [
        { name: 'Kekerasan Intens', icon: 'warning-triangle', description: 'Pertarungan sengit menggunakan tongkat sihir melawan monster mitologi.' },
        { name: 'Darah Ringan', icon: 'skull', description: 'Menampilkan efek visual darah selama pertempuran tertentu.' },
        { name: 'Tema Gelap', icon: 'eye', description: 'Menampilkan atmosfir cerita yang kelam dan makhluk-makhluk mistis yang menyeramkan.' },
      ],
    },
    {
      slug: 'cyberpunk-2077',
      name: 'Cyberpunk 2077',
      cover_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/covers/cyberpunk2077-cover.jpeg',
      background_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/backgrounds/cyberpunk2077-background.jpeg',
      description: 'Cyberpunk 2077 adalah RPG aksi-petualangan open world yang berlatar di megalopolis Night City, tempat Anda bermain sebagai tentara bayaran cyberpunk.',
      trailer_url: 'https://youtu.be/8X2kIfS6fb8?si=6YnbYdqY5BSt7cvq',
      trailer_duration: '01:41',
      platform: ['PC', 'PlayStation'],
      release_year: 2020,
      ...
      content_descriptors: [
        { name: 'Kekerasan Ekstrem', icon: 'warning-triangle', description: 'Baku tembak dan mutilasi menggunakan senjata siber futuristik.' },
        { name: 'Bahasa Kasar', icon: 'message-x', description: 'Dialog cerita mengandung banyak kata-kata kotor dan umpatan dewasa.' },
        { name: 'Konten Dewasa', icon: 'heart', description: 'Menampilkan ketelanjangan dan tema seksual yang eksplisit.' },
      ],
    },
    {
      slug: 'fc-25',
      name: 'EA Sports FC 25',
      cover_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/covers/easport-cover.jpeg',
      background_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/backgrounds/easport-background.jpeg',
      description: 'EA Sports FC 25 menghadirkan simulasi sepak bola paling realistis dengan teknologi animasi mutakhir dan mode Ultimate Team yang kompetitif.',
      trailer_url: 'https://youtu.be/pBM2xyco_Kg?si=pVGwdXGYOaPPB76m',
      trailer_duration: '02:07',
      platform: ['PC', 'PlayStation', 'Nintendo'],
      release_year: 2024,
      developer: 'EA Sports',
      size: '50 GB',
      game_modes: ['Singleplayer', 'Multiplayer', 'Offline', 'Online'],
      is_popular: false,
      rating_code: 'SU',
      genres: [
      ...
      content_descriptors: [
        { name: 'Interaksi Online', icon: 'message-circle', description: 'Pemain dapat bertanding dan berkomunikasi dengan pemain lain secara global.' },
        { name: 'Pembelian In-Game', icon: 'file-text', description: 'Mengandung pembelian poin mikrotransaksi untuk membuka paket pemain.' },
        { name: 'Kompetisi Intens', icon: 'activity', description: 'Elemen pertandingan online yang memicu adrenalin dan sifat kompetitif tinggi.' },
      ],
    },
    {
      slug: 'animal-crossing-new-horizons',
      name: 'Animal Crossing: New Horizons',
      cover_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/covers/animalcros-cover.jpeg',
      background_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/backgrounds/animalcros-background.jpeg',
      description: 'Mulailah kehidupan baru di pulau terpencil. Dekorasi rumah Anda, pancing ikan, dan bangun komunitas impian bersama para warga hewan yang lucu.',
      trailer_url: 'https://youtu.be/_3YNL0OWio0?si=bbM4q5zdlN44UlEX',
      trailer_duration: '01:47',
      platform: ['Nintendo'],
      release_year: 2020,
      developer: 'Nintendo',
      size: '7 GB',
      ...
      content_descriptors: [
        { name: 'Interaksi Sosial', icon: 'users', description: 'Pemain dapat mengunjungi pulau satu sama lain dan bertukar barang.' },
        { name: 'Simulasi Ekonomi', icon: 'coins', description: 'Sistem jual beli lobak dan dekorasi untuk mengembangkan infrastruktur pulau.' },
        { name: 'Kustomisasi Luas', icon: 'paint-bucket', description: 'Kebebasan penuh mendesain pakaian dan tata kota pulau secara kreatif.' },
      ],
    },
    {
      slug: 'super-mario-bros-wonder',
      name: 'Super Mario Bros. Wonder',
      cover_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/covers/supermario-cover.jpeg',
      background_image_url: 'https://tbaytbnfqglcnjmireuj.supabase.co/storage/v1/object/public/backgrounds/supermario-background.jpeg',
      description: 'Petualangan sampingan Mario klasik yang penuh dengan kejutan ajaib berkat Wonder Flower yang mengubah dunia permainan secara tak terduga.',
      trailer_url: 'https://youtu.be/JStAYvbeSHc?si=ZjpoSdVHUJ1WbsBr',
      trailer_duration: '02:39',
      platform: ['Nintendo'],
      release_year: 2023,
      developer: 'Nintendo',
      size: '4 GB',
      ...
      content_descriptors: [
        { name: 'Kekerasan Kartun', icon: 'sword', description: 'Aksi melompat di atas musuh kartun tanpa efek cedera yang realistis.' },
        { name: 'Fitur Co-op Multiplayer', icon: 'smile', description: 'Bermain bersama hingga 4 pemain secara lokal untuk menyelesaikan rintangan.' },
        { name: 'Efek Visual Fantasi', icon: 'zap', description: 'Transformasi karakter menjadi gajah dan efek magis penuh warna di layar.' },
      ],
    }
  ];
